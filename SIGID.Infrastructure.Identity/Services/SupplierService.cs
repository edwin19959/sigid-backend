...
namespace SIGID.Infrastructure.Persistence.Services
{
    public class SupplierService : ISupplierService
    {
        ...
        public async Task<SupplierDTO?> GetByIdAsync(string id)
        {
            ...
            return new SupplierDTO { Id = s.Id, Name = s.Name, Email = s.Email, Phone = s.Phone, Address = s.Address, Status = s.Status };
        }
        ...
        public async Task<SupplierDTO> CreateAsync(CreateSupplierDTO dto)
        {
            ...
            return new SupplierDTO { Id = supplier.Id, Name = supplier.Name, Email = supplier.Email, Phone = supplier.Phone, Address = supplier.Address, Status = supplier.Status };
        }
